...
export const faq = [
  {
    id: "0",
    question: "Xoraのセットアップは簡単ですか？",
    answer:
      "はい、Xoraのセットアップは非常に簡単です。数クリックでアカウントを作成し、すぐに使い始めることができます。詳しい手順は、ヘルプドキュメントをご覧ください。",
  },
  {
    id: "1",
    question: "Xoraを他のプラットフォームと統合できますか？",
    answer:
      "現在、Xoraはいくつかのプラットフォームとの統合をサポートしています。詳細については、統合ページをご覧ください。また、今後さらに多くのプラットフォームとの統合を予定しています。",
  },
  {
    id: "2",
    question: "新しいコンテンツはどのくらいの頻度で追加されますか？",
    answer:
      "私たちは常にXoraの改善に取り組んでおり、定期的に新しいコンテンツや機能を追加しています。最新のアップデートについては、ニュースセクションまたはソーシャルメディアをご覧ください。",
  },
  {
    id: "3",
    question: "返金ポリシーは何ですか？",
    answer:
      "返金ポリシーについては、利用規約の返金ポリシーセクションをご覧ください。",
  },
  {
    id: "4",
    question: "法人プランはありますか？",
    answer:
      "はい、法人プランをご用意しています。法人プランの詳細については、お問い合わせください。",
  },
  {
    id: "5",
    question: "ストレージが不足したらどうなりますか？",
    answer:
      "ストレージが不足した場合、追加ストレージを購入するか、不要なファイルを削除してストレージ容量を確保することができます。プランのアップグレードも可能です。",
  },
  {
    id: "6",
    question: "プランをアップグレードできますか？",
    answer:
      "はい、いつでもプランをアップグレードできます。プランのアップグレードは、アカウント設定から行えます。日割り計算された割引が適用されます。",
  },
  {
    id: "7",
    question: "チームを招待するにはどうすればよいですか？",
    answer:
      "チームメンバーを招待するには、チーム管理ページから招待リンクを送信してください。",
  },
  {
    id: "8",
    question: "個人とチーム向けのトレーニングは提供されていますか？",
    answer:
      "はい、個人とチーム向けのトレーニングを提供しています。トレーニングの詳細については、お問い合わせください。",
  },
  {
    id: "9",
    question: "アカウントがロックアウトされました。どうすればよいですか？",
    answer:
      "アカウントがロックアウトされた場合は、パスワードリセットの手順に従ってください。それでも解決しない場合は、サポートチームまでご連絡ください。",
  },
];
...
export const testimonials = [
  ...
  },
  {
    ...
    comment:
      "最初は懐疑的でしたが、今ではそれなしでコンテンツ運用を想像できません。それほど影響力があります。",
  },
  {
    id: "2",
    name: "メラニー・ハースト",
    ...
    comment:
      "このソフトウェアの導入は簡単でした。日々のタスクが非常にシンプルになりました。",
  },
  {
    id: "3",
    name: "アリシア・バーカー",
    ...
    comment:
      "分析機能は、まるで個人的な占い師のようです。ビジネス上の意思決定を導く上で役立っています。",
  },
  {
    id: "4",
    name: "ベッキー・スナイダー",
    ...
    comment:
      "先月Xoraに切り替え、すでに結果が出ています。私たちのチームにとって最良の決断です！",
  },
  {
    id: "5",
    name: "ジム・ブラッドリー",
    ...
    comment:
      "効率の向上は否定できません。このプラットフォームは私たちのワークフローを永遠に変えました。",
  },
];
